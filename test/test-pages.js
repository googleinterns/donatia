...
it("Dashboard categories page", function (done) {
  request("http://localhost:3000/dashboard/testorg/categories", function (
    error,
    response,
    body
  ) {
...
it("Dashboard view page", function (done) {
  request("http://localhost:3000/dashboard/testorg", function (
    error,
    response,
    body
  ) {
...
it("Dashboard edit page", function (done) {
  request("http://localhost:3000/dashboard/organization/edit", function (
    error,
    response,
    body
  ) {
